...
public class EchoDownloadedView extends DialogFragment implements View.OnClickListener{
	private LinearLayout EchoDownloadedView;
	...
	public EchoDownloadedView(){
		
	}

	public static EchoDownloadedView newInstance(int num){	
		EchoDownloadedView echoShoutFragment = new EchoDownloadedView();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
	  Bundle savedInsntaceState) {
		...
		EchoDownloadedView = (LinearLayout) inflater.inflate(R.layout.echo_downloaded, null);
		...
		echoWritingInfo = (LinearLayout) EchoDownloadedView.findViewById(R.id.writing_info);
		
		// Buttons
		echo_shout_btn = (Button) EchoDownloadedView.findViewById(R.id.echo_shout_btn);
		echo_add_photo_btn = (Button) EchoDownloadedView.findViewById(R.id.echo_add_photo_btn);
