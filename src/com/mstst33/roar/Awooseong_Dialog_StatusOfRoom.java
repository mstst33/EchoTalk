...
public class Awooseong_Dialog_StatusOfRoom extends Dialog implements View.OnClickListener{
	...
	public Awooseong_Dialog_StatusOfRoom(Context context, int theme, Awooseong_ThemeRoom info) {
