...
public class ViewUnbindHelper {
	 ...
	 * method of each activity. This code may stinks, but better than worse -
	 * suspiciously, Android framework does not free resources immediately which
	 * are consumed by Views and this leads to OutOfMemoryError sometimes
